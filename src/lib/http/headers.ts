...
// blocks (ui/styles.ts PUBLIC_STYLE + ADMIN_STYLE) are allowlisted by sha256 hash. csp.test.ts
// recomputes both hashes from the exported constants — editing the CSS without updating these
// fails that test with the correct values printed. img-src data: is for the inline SVG favicon.
export const ADMIN_CSP =
  "default-src 'self'; " +
  "style-src 'sha256-yAEFmINTkCHC3+A/1bv1OXvr7Zwb8UtKjnlSoXwayrc=' 'sha256-5N4cbBBu34Ztdss6LdtM44ZuvBThXltJJWZwCko6l54='; " +
  "img-src 'self' data:; " +
